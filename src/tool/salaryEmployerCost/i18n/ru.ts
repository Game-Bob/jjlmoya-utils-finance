...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Компания платит зарплату брутто плюс свои взносы в социальное страхование. Брутто служит основой модели: затем оцениваются удержания работника и налог IRPF, чтобы получить нетто. К расходам компании добавляются взносы работодателя, включая выбранную ставку производственного риска. Проверьте, указана ли сумма за год или за месяц и предусмотрено ли двенадцать или четырнадцать выплат. Дополнительные выплаты меняют среднюю сумму одной ведомости, но не должны менять согласованный годовой брутто. Используйте результат для сравнения предложений и бюджета, а важные решения проверяйте по свежей расчётной ведомости." },
    ...
    { type: 'paragraph', html: "Только Испания. Общий режим 2026 года, полная занятость и обычная денежная зарплата. Расчёты являются ориентировочными. Чистая зарплата и расходы работодателя меняются из-за личных обстоятельств, региона, льгот, премий, типа договора и обновления правил. Для честного сравнения предложений используйте одинаковые удержания IRPF, число выплат, базу взносов и ставку производственного риска. Двенадцать или четырнадцать выплат не меняют годовую сумму брутто, но меняют среднюю сумму одной выплаты. Для высокой зарплаты предел базы и солидарный взнос могут заметно повлиять на результат. Модель не учитывает неполную занятость, самозанятость, необычные бонусы и будущие исправления расчётного листка. Сохраните допущения и проверьте важные решения по свежей ведомости или официальному расчёту. Повторите расчёт после изменения налогового года, договора, ставок или личных данных." },
  ],
  faq,
  bibliography,
  howTo,
