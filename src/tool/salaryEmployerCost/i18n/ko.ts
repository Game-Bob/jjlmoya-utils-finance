...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "스페인 전용. 2026 일반제도, 풀타임, 현금 급여 대상. 본 결과는 추정치입니다. 실제 순수령액과 회사 비용은 가족 상황, 지역 세금, 복리후생, 보너스 및 계약 조건에 따라 달라질 수 있습니다. IRPF, 계약 형태, 지급 횟수와 산재보험료율을 같은 기준으로 맞춰 비교하고, 중요한 판단에서는 공식 급여 계산이나 전문가의 확인을 받으세요. 12회와 14회 지급은 연간 총액을 바꾸지 않고 지급당 평균만 바꾸며, 고액 급여에는 기여금 상한과 연대 부담금이 적용될 수 있습니다." },
  ],
  faq,
  bibliography,
  howTo,
