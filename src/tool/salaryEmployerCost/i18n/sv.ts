...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Företaget betalar bruttolönen plus sina arbetsgivaravgifter till socialförsäkringen." },
    ...
    { type: 'paragraph', html: "Endast Spanien. Allmänna systemet 2026, heltid. Resultaten är uppskattningar." },
  ],
  faq,
  bibliography,
  howTo,
