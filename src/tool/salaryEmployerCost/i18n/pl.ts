...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Firma płaci wynagrodzenie brutto plus składki na ubezpieczenie społeczne pracodawcy. Wynagrodzenie brutto jest punktem wyjścia, a następnie model odejmuje składki pracownika i zaliczkę IRPF, aby oszacować kwotę netto. Do kosztu firmy dodawane są składki pracodawcy, w tym wybrana stawka wypadkowa. Zawsze sprawdź, czy podana kwota jest roczna czy miesięczna i czy oferta obejmuje dwanaście, czy czternaście wypłat. Wypłaty dodatkowe zmieniają kwotę pojedynczego przelewu, ale nie powinny zmieniać uzgodnionego brutto rocznego. Wynik służy do porównania ofert i budżetowania, a nie zastępuje aktualnej listy płac." },
    ...
    { type: 'paragraph', html: "Tylko Hiszpania. System Ogólny 2026, pełny wymiar czasu pracy i zwykłe wynagrodzenie pieniężne. Wyniki są szacunkowe. Rzeczywiste wynagrodzenie netto i koszt pracodawcy mogą się zmienić przez sytuację osobistą pracownika, region podatkowy, świadczenia rzeczowe, premie, rodzaj umowy i aktualne zasady rozliczeń. Przy porównywaniu ofert stosuj tę samą zaliczkę IRPF, liczbę wypłat, podstawę składek i stawkę wypadkową. Dwanaście lub czternaście wypłat nie zmienia rocznej kwoty brutto, ale zmienia średnią kwotę pojedynczej wypłaty. Przy wysokich zarobkach limit podstawy i składka solidarnościowa mogą istotnie wpłynąć na wynik. Model nie obejmuje pracy w niepełnym wymiarze, samozatrudnienia, nietypowych bonusów ani późniejszych korekt listy płac. Zapisz przyjęte założenia i zweryfikuj ważne decyzje na aktualnym pasku wynagrodzeń lub w oficjalnym wyliczeniu. Przelicz wynik ponownie po zmianie stawek, roku podatkowego, rodzaju umowy lub danych osobistych, ponieważ te elementy mogą zmienić potrącenia i koszt firmy." },
  ],
  faq,
  bibliography,
  howTo,
