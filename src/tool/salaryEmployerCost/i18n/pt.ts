...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "A empresa paga o salário bruto mais as suas contribuições para a Segurança Social. O bruto é a base do modelo: depois são estimadas as contribuições do trabalhador e a retenção de IRPF para chegar ao líquido. Ao custo da empresa somam-se as contribuições patronais, incluindo a taxa de acidentes escolhida. Confirme se o valor introduzido é anual ou mensal e se a oferta prevê doze ou catorze pagamentos. Os pagamentos extra alteram o valor médio de cada recibo, mas não devem alterar o bruto anual acordado. Use o resultado para comparar propostas e preparar um orçamento; para decisões importantes, confirme-o num recibo recente." },
    ...
    { type: 'paragraph', html: "Apenas Espanha. Regime Geral 2026, tempo inteiro e salário em dinheiro. Os resultados são estimativas. O salário líquido e o custo real da empresa podem mudar por circunstâncias pessoais, região fiscal, benefícios, prémios, tipo de contrato e regras atualizadas. Para comparar ofertas, mantenha constantes a retenção de IRPF, o número de pagamentos, a base contributiva e o prémio de acidentes. Doze ou catorze pagamentos não alteram o bruto anual, mas alteram a média por pagamento. Em salários elevados, o teto contributivo e a contribuição de solidariedade podem influenciar o resultado. O modelo não cobre trabalho parcial, atividade independente, bónus atípicos ou correções posteriores do recibo. Guarde as premissas e confirme decisões importantes num recibo recente ou num cálculo oficial. Volte a calcular quando mudar o ano fiscal, o contrato, as taxas ou os dados pessoais." },
  ],
  faq,
  bibliography,
  howTo,
