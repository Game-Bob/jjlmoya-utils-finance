...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Hitung gaji bersih, potongan IRPF, iuran pekerja, dan total biaya perusahaan di Spanyol berdasarkan aturan 2026." },
    { type: 'title', text: "Formula biaya perusahaan Spanyol", level: 2 },
    { type: 'paragraph', html: "Perusahaan membayar gaji kotor ditambah iuran jaminan sosial perusahaan." },
    { type: 'table', headers: ['Layer', 'Details'], rows: [['Net', "Inti Gaji Bersih"], ['Employer Cost', "Total Biaya Perusahaan"]] },
    { type: 'title', text: "Tarif Jaminan Sosial Spanyol 2026 yang disertakan", level: 2 },
    { type: 'paragraph', html: "Estimasi mencakup kontinjensi umum, pengangguran, pelatihan, MEI, FOGASA, dan premi kecelakaan kerja." },
    { type: 'table', headers: ['Preset', 'Rate'], rows: [["Kantor 1,50%", '1.50%'], ["Penjualan / Komersial 2,00%", '2.00%'], ["Konstruksi 6,70%", '6.70%']] },
    { type: 'title', text: "Batas iuran dan gaji tinggi", level: 2 },
    { type: 'paragraph', html: "Batas maksimum bulanan 2026 adalah €5.101,20. Di atas itu berlaku iuran solidaritas progresif." },
    { type: 'title', text: "Skema 12 pembayaran dan 14 pembayaran", level: 2 },
    { type: 'paragraph', html: "Tidak. Kalkulator mempertahankan total kotor tahunan yang sama." },
    { type: 'tip', title: "Jadwal Pembayaran", html: "Pilih 12/14 pembayaran, jenis kontrak, IRPF, dan premi risiko." },
    { type: 'title', text: "Batasan estimasi gaji Spanyol ini", level: 2 },
    { type: 'paragraph', html: "Khusus Spanyol. Skema Umum 2026, kerja penuh waktu, gaji tunai biasa. Hasil berupa estimasi." },
  ],
  faq,
  bibliography,
  howTo,
