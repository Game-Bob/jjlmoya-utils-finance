...
export const content: ToolLocaleContent<SalaryEmployerCostUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Şirket brüt maaşı ve kendi sosyal güvenlik primlerini öder." },
    ...
    { type: 'paragraph', html: "Yalnızca İspanya. 2026 Genel Rejim, tam zamanlı çalışma. Sonuçlar tahmini niteliktedir." },
  ],
  faq,
  bibliography,
  howTo,
