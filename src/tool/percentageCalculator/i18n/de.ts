...
export const content: ToolLocaleContent<PercentageCalculatorUI> = {
  ...
  bibliography: [
    {
      name: 'Prozentrechnung - Wikipedia',
      url: 'https://de.wikipedia.org/wiki/Prozentsatz',
    },
    {
      name: 'Mathematische Grundlagen - Khan Academy',
      url: 'https://de.khanacademy.org/math/pre-algebra/pre-algebra-ratios-rates/pre-algebra-percents/v/describing-the-meaning-of-percent',
    },
  ],
  howTo: howToData,
