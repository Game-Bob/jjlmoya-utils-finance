...
export const content: ToolLocaleContent<RevolvingCardCalculatorUI> = {
  ...
  { type: 'paragraph', html: "利用する前に、計算機が示す前提条件と結果を一緒に確認してください。残高、実質年率、返済方法、手数料、利用明細を確認し、毎月の返済額だけでなく支払総額と返済期間を比較しましょう。" },
  ...
  { type: 'paragraph', html: "結果は計画や条件比較に使えますが、公式計算や専門家の助言の代わりにはなりません。" },
  { type: 'paragraph', html: "利用する前に、計算機が示す前提条件と結果を一緒に確認してください。" },
  { type: 'paragraph', html: "入力値、単位、丸め、日付、地域を確認してください。どれも推定結果を変える可能性があります。残高、実質年率、毎月の返済額、手数料、新規利用の有無によって実際の返済期間は変わるため、契約書と利用明細も確認してください。月々の返済額だけで判断せず、支払総額と利息の内訳、返済予定表を一緒に確認しましょう。これは契約の適法性を確定するものではありません。無理のない固定返済額と、現在の残高を減らす計画を検討してください。金利が高い場合は、追加利用を止め、専門家や相談窓口に早めに確認することも大切です。" },],
  ui: {
