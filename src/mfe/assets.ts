...
const UTILITY_ASSET_ROOT = "/_utilities/finance";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/finance/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/finance/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("finance");
